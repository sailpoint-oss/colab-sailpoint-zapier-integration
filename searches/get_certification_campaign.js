const perform = (z, bundle) => {
  const options = {
    url: `https://${bundle.authData.idn_org}.api.identitynow.com/v3/certifications/${bundle.inputData.id}`,
    method: 'GET',
    headers: {
...
module.exports = {
    ...
    inputFields: [
      {
        ...
        type: 'string',
        helpText: 'The ID of the certification to retrieve.',
        required: true,
        list: false,
  ...
  key: 'get_certification_campaign',
  noun: 'Campaign',
  display: {
    label: 'Get Certification Campaign',
