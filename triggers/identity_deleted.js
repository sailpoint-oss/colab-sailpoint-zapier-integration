...
const performSubscribe = (z, bundle) => {
  const options = {
    ...
    body: {
      ...
      triggerId: 'idn:identity-deleted',
      type: 'HTTP',
      httpConfig: {
...
module.exports = {
  operation: {
    ...
    outputFields: [
      ...
      { key: 'attributes__email', label: 'Email' },
    ],
  },
  key: 'identity_deleted',
  noun: 'Identity',
  display: {
    label: 'Identity Deleted',
    description: 'Triggers when an identity is deleted in IdentityNow.',
    directions:
      'You might think of this as when someone is fired or has otherwise left the company and their digital identity is deleted.',
    hidden: false,
    important: true,
  },
};
